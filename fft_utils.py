...
#     """
#     Apply real mask to 2-channel complex torch tensor

#     Parameters:
#     ---------
#     x: torch complex tensor
#         input array
#     mask: torch real tensor        
#         sampling mask

#     Returns
#     ----------
#     Output torch complex tensor with same shape as x
#         with applied mask
#     """
#     real = torch.take
...
# response = requests.get('https://prod-images-static.radiopaedia.org/images/13656005/bd937738ad6223a03f8aedcf4920a7_big_gallery.jpeg')
# img = Image.open(BytesIO(response.content))
# img = np.array(img,dtype=np.float)
# plt.imshow(img,cmap='gray')
    
# img_tensor = torch.from_numpy(img)
# img_tensor = real_2_complex(img_tensor)

# fft_tensor = fftc2d(img_tensor)
# ifft_tensor = ifftc2d(fft_tensor)

# fft_numpy = complex_2_numpy(fft_tensor)
# ifft_numpy = complex_2_numpy(ifft_tensor)
